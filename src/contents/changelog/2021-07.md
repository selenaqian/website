...
~~Great work team, let's shift our focus to other areas we can improve.~~ These improvements are certainly worth celebrating 🎂, but we're hungry to drop these times by at least the same magnitude once or twice more! Team, finish your cake and get back to work 😉.

Please do let us know if you notice any differences with your projects. You can find us at [www.gitpod.io/chat](https://www.gitpod.io/chat).
...
- [#447](https://github.com/gitpod-io/workspace-images/pull/447) - Display current git branch in the terminal prompt (PS1). Thanks to [@Shulammite-Aso](https://github.com/Shulammite-Aso).
...
<p><Contributors usernames="akosyakov,AlexTugarev,corneliusludmann,csweichel,fntlnz,geropl,ghuntley,philschatz,shaal,Shulammite-Aso" /></p>
